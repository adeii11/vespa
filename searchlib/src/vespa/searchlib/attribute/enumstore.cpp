...
template class UniqueStore<const char*, InternalIndex, UniqueStoreStringAllocator<InternalIndex>>;
template class UniqueStore<int8_t, InternalIndex>;
template class UniqueStore<int16_t, InternalIndex>;
template class UniqueStore<int32_t, InternalIndex>;
template class UniqueStore<int64_t, InternalIndex>;
template class UniqueStore<float, InternalIndex>;
template class UniqueStore<double, InternalIndex>;
